...
from utils.decorators import admins
from pyrogram import Client, filters
from pyrogram.enums.parse_mode import ParseMode

@admins
@Client.on_message(filters.command("ban") & filters.chat(group_ids))
...
@admins
@Client.on_message(filters.command("unban") & filters.chat(group_ids))
...
@admins
@Client.on_message(filters.command("admin") & filters.chat(group_ids))
